This repository contains tools for calculating the relative risk, temperature related virus die-off and expected number of infectious virus copies in waste water for SARS CoV-2.
